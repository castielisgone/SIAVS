...
public class RespostasDAO extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //String sql = "CREATE TABLE Respostas (id INTEGER PRIMARY KEY, resposta1 TEXT NOT NULL, resposta2 TEXT NOT NULL, resposta3 TEXT NOT NULL," +
        ...
        String sql = "CREATE TABLE Respostas (id INTEGER PRIMARY KEY, resposta1 TEXT NOT NULL)";
        db.execSQL(sql);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql = "DROP TABLE IF EXISTS Respostas";
        db.execSQL(sql);
        onCreate(db);
    }
    ...
    public void insere(Respostas resposta) {
       ...
       // dados.put("resposta2", resposta.getResposta2());
        //dados.put("resposta3", resposta.getResposta3());
       // dados.put("resposta4", resposta.getResposta4());
        ////.put("resposta5", resposta.getResposta5());
//       // dados.put("resposta7", resposta.getResposta7());
       // dados.put("resposta8", resposta.getResposta8());
       // dados.put("resposta9", resposta.getResposta9());
        //dados.put("resposta10", resposta.getResposta10());
        System.out.println("CHAMOU");
        db.insert("Respostas", null, dados);
    ...
    private ContentValues pegaDadosResposta(Respostas resposta) {
       ...
       /* dados.put("resposta2", resposta.getResposta2());
        dados.put("resposta3", resposta.getResposta3());
        dados.put("resposta4", resposta.getResposta4());
        dados.put("resposta5", resposta.getResposta5());
        dados.put("resposta6", resposta.getResposta6());
        dados.put("resposta7", resposta.getResposta7());
        dados.put("resposta8", resposta.getResposta8());
        dados.put("resposta9", resposta.getResposta9());
        dados.put("resposta10", resposta.getResposta10());*/
